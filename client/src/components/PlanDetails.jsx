  ...
  render() {
    ...
    return(
      <div style={{fontFamily: "Verdana", fontSize:"12px"}}>
        ...
        <span onClick={this.openModal.bind(this)} style={{fontSize:"10px", textDecoration: "underline"}}>See plan details</span>
        <Modal visible={this.state.show} width="500" height="400" effect="fadeInUp" onClickAway={this.closeModal.bind(this)}>
          <div>
            <h1>See plan details</h1>
            ...
            <div onClick={this.closeModal.bind(this)}>Close</div>
          </div>
        </Modal>
      </div>
    )
